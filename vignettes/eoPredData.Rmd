...
**EHEH8090** Pre-trained model object using `mixOmics`. Training and validation are described in 
`r Citep(bib[["eoPredData"]])`.

**EHEH8403** DNA methylation test data, use to demonstrate prediction of preeclampsia status using eoPred model. A `matrix`.
